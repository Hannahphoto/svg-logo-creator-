...
describe('Circle', () =>{
    it('should render correctly', () => {
        ...
        const output = `<svg height="300" width="300"><circle cx="150" cy="150" r="100" style="fill:orange"/><text x="150px" y="150px" font-size="60px" text-anchor="middle" dominant-baseline="middle" fill="black">PPP</text></svg>`;
        expect(shape.render()).toEqual(output);
    });
});
